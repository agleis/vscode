...
MenuRegistry.appendMenuItem(MenuId.EditorTitleContext, { command: { id: editorCommands.ADHS_EDITOR_COMMAND_ID, title: nls.localize('adhs', "Pin"), precondition: EditorAdhsdContext.toNegated() }, group: '3_preview', order: 10 });
MenuRegistry.appendMenuItem(MenuId.EditorTitleContext, { command: { id: editorCommands.UNADHS_EDITOR_COMMAND_ID, title: nls.localize('unadhs', "Unpin"), precondition: EditorAdhsdContext }, group: '3_preview', order: 10 });
...
MenuRegistry.appendMenuItem(MenuId.CommandPalette, { command: { id: editorCommands.ADHS_EDITOR_COMMAND_ID, title: { value: nls.localize('adhsEditor', "Pin Editor"), original: 'Pin Editor' }, category: viewCategory } });
MenuRegistry.appendMenuItem(MenuId.CommandPalette, { command: { id: editorCommands.UNADHS_EDITOR_COMMAND_ID, title: { value: nls.localize('unadhsEditor', "Unpin Editor"), original: 'Unpin Editor' }, category: viewCategory } });
